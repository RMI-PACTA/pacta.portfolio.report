test_that("translation data does not contain duplicate key rows", {
  ...
  dataframe_headers <- readr::read_csv("../../data/translation/dataframe_headers.csv", col_types = "c")
  dataframe_labels <- readr::read_csv("../../data/translation/dataframe_labels.csv", col_types = "c")
  js_labels <- jsonlite::fromJSON("../../data/translation/js_labels.json")
